...
export function AdaptiveAnalysis({ metrics, sleepNights, allMetrics, allSleep, windowDays, periodLabel }: Props) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
      {insights.length > 0 && <SmartInsightsCard insights={insights} periodLabel={periodLabel} />}
...
/* ═══════════════════════════════════════════════════════════════
 *  SMART INSIGHTS CARD — renders period-aware statistical insights
 *  generated by generateSmartInsights (Mann-Kendall, Banister, etc.)
 * ═══════════════════════════════════════════════════════════════ */
function SmartInsightsCard({ insights, periodLabel }: { insights: SmartInsight[]; periodLabel: string }) {
  const sevColor = (s: SmartInsight["severity"]) =>
    s === "critical" ? "#FF3B30"
    : s === "warning" ? "#FF9500"
    : s === "positive" ? "#34C759"
    : "#5AC8FA";

  const sevIcon = (s: SmartInsight["severity"]) =>
    s === "critical" ? "⚠" : s === "warning" ? "•" : s === "positive" ? "✓" : "i";

  return (
    <section>
      <div className="hh-section-label">
        <span>Ce spun datele</span>
      ...
      <div className="hh-card" style={{ minWidth: 0, padding: 0 }}>
        {insights.map((ins, i) => (
          <div
            ...
            style={{
              padding: "14px 16px",
              borderTop: i === 0 ? "none" : "0.5px solid rgba(84,84,88,0.3)",
              display: "flex",
              gap: 12,
          ...
          >
            <span
              ...
              style={{
                ...
                height: 22,
                borderRadius: 999,
                background: `${sevColor(ins.severity)}22`,
            ...
            <div style={{ minWidth: 0, flex: 1 }}>
              <p className="hh-subheadline" style={{ color: "var(--label-primary)", fontWeight: 600, marginBottom: 2 }}>
                {ins.title}
              </p>
